<template>
    <div>
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-2 py-6 sm:px-6 lg:px-4 flex items-center justify-between">
        ...
        <main class="px-6 py-4 lg:px-36">
            <div class="grid grid-cols-1 gap-12 sm:grid-cols-2 md:grid-cols-3">
                ...
                >
                    ...
                    <img :src="product.image" alt="" class="w-full h-54 object-cover">
                    <div class="mt-4 flex justify-between items-center">
                        <h1 class="text-lg font-bold">{{ product.name }}</h1>
                        <p class="text-lg text-gray-500">{{ product.price }} DH</p>
                    </div>
                    <div v-html="product.description" class="overflow-hidden"></div>
